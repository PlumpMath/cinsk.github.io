...
$key = q/20.37/;
$external_latex_labels{$key} = q|20.8|; 
$noresave{$key} = "$nosave";
...
$key = q/faq:good-debugger/;
$external_latex_labels{$key} = q|21.2|; 
$noresave{$key} = "$nosave";
